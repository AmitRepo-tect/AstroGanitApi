...
public enum ResultCode {
	// General
	SUCCESS(1, "Successful"), PROFILE_UPDATE_SUCCESSFUL(1, "Profile updated successfully"), EXCEPTION(0, "Exception"),
	INTERNAL_SERVER_ERROR(19, "Internal Server Error"), UNAUTHORIZED(15, "Unauthorized"),
	...
	// Login user
	INVALID_PARAMETER(2, "Invalid parameter"), USER_NOT_ACTIVE(3, "User not active"),
	INCORRECT_PASSWORD(4, "Incorrect password"),

	// OTP send
	LIMIT_REACHED(10, "OTP limit reached"), SMS_ERROR(11, "SMS sending failed"),
	SERVER_ERROR(12, "Internal server error"), OTP_SENT(13, "OTP sent successfully"),
	TOO_SOON(14, "OTP already sent. Please wait 30 seconds before requesting a new OTP."),

	// Verify OTP
	OTP_INVALID(2, "Invalid OTP"), OTP_EXPIRED(3, "OTP expired"), OTP_ALREADY_USED(4, "OTP already verified"),
	MAX_ATTEMPTS_REACHED(6, "Max attempts reached"), OTP_NOT_FOUND(7, "OTP not found"),
	OTP_VERIFICATION_FAILED(8, "Failed to verify OTP and complete login"),

	// User status
	USER_ALREADY_ACTIVE(8, "User already active"), USER_ALREADY_DEACTIVATE(9, "User already deactivated"),
